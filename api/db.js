...
const COUNTRY_TAX_DEFAULTS = {
  ...
  IT: { label: 'Italy',            tiers: [{name:'Standard Rate', code:'standard', rate:22},   {name:'Reduced Rate', code:'reduced', rate:10}, {name:'Exempt', code:'exempt', rate:0}] },
  ES: { label: 'Spain',            tiers: [{name:'Standard Rate', code:'standard', rate:21},   {name:'Reduced Rate', code:'reduced', rate:10}, {name:'Exempt', code:'exempt', rate:0}] },
  NL: { label: 'Netherlands',      tiers: [{name:'Standard Rate', code:'standard', rate:21},   {name:'Reduced Rate', code:'reduced', rate:9}, {name:'Exempt', code:'exempt', rate:0}] },
  BE: { label: 'Belgium',          tiers: [{name:'Standard Rate', code:'standard', rate:21},   {name:'Reduced Rate', code:'reduced', rate:6}, {name:'Exempt', code:'exempt', rate:0}] },
  IE: { label: 'Ireland',          tiers: [{name:'Standard Rate', code:'standard', rate:23},   {name:'Reduced Rate', code:'reduced', rate:13.5}, {name:'Exempt', code:'exempt', rate:0}] },
  PT: { label: 'Portugal',         tiers: [{name:'Standard Rate', code:'standard', rate:23},   {name:'Reduced Rate', code:'reduced', rate:13}, {name:'Exempt', code:'exempt', rate:0}] },
  AT: { label: 'Austria',          tiers: [{name:'Standard Rate', code:'standard', rate:20},   {name:'Reduced Rate', code:'reduced', rate:10}, {name:'Exempt', code:'exempt', rate:0}] },
  SE: { label: 'Sweden',           tiers: [{name:'Standard Rate', code:'standard', rate:25},   {name:'Reduced Rate', code:'reduced', rate:12}, {name:'Exempt', code:'exempt', rate:0}] },
  DK: { label: 'Denmark',          tiers: [{name:'Standard Rate', code:'standard', rate:25},   {name:'Exempt', code:'exempt', rate:0}] },
  NO: { label: 'Norway',           tiers: [{name:'Standard Rate', code:'standard', rate:25},   {name:'Reduced Rate', code:'reduced', rate:15}, {name:'Exempt', code:'exempt', rate:0}] },
  FI: { label: 'Finland',          tiers: [{name:'Standard Rate', code:'standard', rate:24},   {name:'Reduced Rate', code:'reduced', rate:14}, {name:'Exempt', code:'exempt', rate:0}] },
  CH: { label: 'Switzerland',      tiers: [{name:'Standard Rate', code:'standard', rate:8.1},  {name:'Reduced Rate', code:'reduced', rate:2.6}, {name:'Exempt', code:'exempt', rate:0}] },
  PL: { label: 'Poland',           tiers: [{name:'Standard Rate', code:'standard', rate:23},   {name:'Reduced Rate', code:'reduced', rate:8}, {name:'Exempt', code:'exempt', rate:0}] },
  CZ: { label: 'Czechia',          tiers: [{name:'Standard Rate', code:'standard', rate:21},   {name:'Reduced Rate', code:'reduced', rate:12}, {name:'Exempt', code:'exempt', rate:0}] },
  GR: { label: 'Greece',           tiers: [{name:'Standard Rate', code:'standard', rate:24},   {name:'Reduced Rate', code:'reduced', rate:13}, {name:'Exempt', code:'exempt', rate:0}] },
  ...
  BR: { label: 'Brazil',           tiers: [{name:'Standard Rate', code:'standard', rate:17},   {name:'Exempt', code:'exempt', rate:0}] },
  AR: { label: 'Argentina',        tiers: [{name:'Standard Rate', code:'standard', rate:21},   {name:'Reduced Rate', code:'reduced', rate:10.5}, {name:'Exempt', code:'exempt', rate:0}] },
  ...
  IN: { label: 'India',            tiers: [{name:'Standard GST', code:'standard', rate:18},    {name:'Reduced GST', code:'reduced', rate:5}, {name:'Exempt', code:'exempt', rate:0}] },
  AU: { label: 'Australia',        tiers: [{name:'Standard GST', code:'standard', rate:10},    {name:'Zero-Rated', code:'zero', rate:0}, {name:'Exempt', code:'exempt', rate:0}] },
  NZ: { label: 'New Zealand',      tiers: [{name:'Standard GST', code:'standard', rate:15},    {name:'Zero-Rated', code:'zero', rate:0}, {name:'Exempt', code:'exempt', rate:0}] },
  SG: { label: 'Singapore',        tiers: [{name:'Standard GST', code:'standard', rate:9},     {name:'Zero-Rated', code:'zero', rate:0}, {name:'Exempt', code:'exempt', rate:0}] },
  ID: { label: 'Indonesia',        tiers: [{name:'Standard Rate', code:'standard', rate:11},   {name:'Exempt', code:'exempt', rate:0}] },
  PH: { label: 'Philippines',      tiers: [{name:'Standard Rate', code:'standard', rate:12},   {name:'Zero-Rated', code:'zero', rate:0}, {name:'Exempt', code:'exempt', rate:0}] },
  VN: { label: 'Vietnam',          tiers: [{name:'Standard Rate', code:'standard', rate:10},   {name:'Reduced Rate', code:'reduced', rate:5}, {name:'Exempt', code:'exempt', rate:0}] },
